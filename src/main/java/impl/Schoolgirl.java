 ...
 */
public class Schoolgirl  implements Pupil,Serializable{
    private String name;
    private Register[] subjects;

    public Schoolgirl(String name, int subjectCount){
        this.name=name;
    ...
    private class Register implements Cloneable,Serializable{
